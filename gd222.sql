...
INSERT INTO `gd_company` (`id`, `address`, `email`, `tel`, `site`, `mob`, `arrive`, `copy`, `beian`) VALUES
(1, '广东省广州市白云区太和镇北太路1633号&lt;br/&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;民营科技园白云火炬大厦1802-1803', '222@gd222.com', '4008-168-332', 'www.gd222.com', '181 2789 3222', '乘地铁至龙归站B1出口转乘735路公交至863中心站；其他公交：563路、650路、701路、728路、758路、828路', '©二二二科技', '粤ICP备14026457号-1');
...
INSERT INTO `gd_menu` (`id`, `title`, `rid`, `url`) VALUES
(1, '菜单列表', 0, ''),
(2, '菜单列表', 1, '/index.php/Admin/Menu/index'),
(3, '功能列表', 0, ''),
(4, '功能列表', 3, '/index.php/Admin/Func/index'),
(5, '导航栏', 0, ''),
(6, '导航栏列表', 5, '/index.php/Admin/Nav/index'),
(7, '公司信息', 0, ''),
(8, '公司信息', 7, '/index.php/Admin/Company/index'),
(9, '新闻列', 0, ''),
(10, '新闻列表', 9, '/index.php/Admin/News/index'),
(11, '建站留言', 0, ''),
(12, '建站留言', 11, '/index.php/Admin/webBuild/index'),
(13, '联系我们', 0, ''),
(14, '联系我们', 13, '/index.php/Admin/Connect/index');
...
CREATE TABLE IF NOT EXISTS `gd_user_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='后台登录日志表' AUTO_INCREMENT=8 ;
